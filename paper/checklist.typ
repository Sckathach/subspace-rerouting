...
+ #claim(
  ...
  justification: [Full numbers in section 4.3 for the ASR and appendix section D.6 for the attack duration claims. Experimental results can be found and reproduced with the linked code repository.], 
  guidelines: [
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [The paper discuss limitation in section 5.],
  guidelines: [
...
+ #claim(
  ...
  answer: answerNA,  // Replace by answerYes, answerNo, or answerNA.
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [The code is released with notebooks to reproduce every experiment and figure present in the paper.],
  guidelines: [
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [The code and datasets are provided, with full instructions to reproduce the work. ],
  guidelines: [
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [Details concerning test are present in section 2 and throughout the appendix. Full details can be found in the provided code. The released datasets contain the generated jailbreaks along with the full configuration of each run.],
  guidelines: [
    - The answer NA means that the paper does not include experiments.
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [The standard deviation is shown in each figure. However, given the resources available and the duration of each optimisation, some experiments were performed on small samples, making it impossible to carry out a proper statistical analysis. Where this is the case, it is clearly indicated.] ,
  guidelines: [
    - The answer NA means that the paper does not include experiments.
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [Compute resources is discussed in section 2.2, while experiments durations are discussed throughout the whole paper.],
  guidelines: [
    - The answer NA means that the paper does not include experiments.
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [To the best of our knowledge, the research conducted conforms with the NeurIPS Code of Ethics. Concerning security, we do not expect to create any additional problem, as our work is limited to small models, which do not provide any real dangerous information.],
  guidelines: [
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [All existing open-source models, datasets, and evaluations that we use are cited. We specify access type and license type in the appendix section B.],
  guidelines: [
...
+ #claim(
  ...
  answer: answerYes,  // Replace by answerYes, answerNo, or answerNA.
  justification: [The code and datasets are released along with documentation, comments, and notebooks to facilitate the reproduction and use of the material.],
  guidelines: [
